...
{
    /// <summary>
    /// The 'ConcreteSubject' (publisher) class
    /// The ConcreteSubject objects store the states of interest to the Observers and also responsible for sending the notification to its observers when its state changes.
    /// </summary>
